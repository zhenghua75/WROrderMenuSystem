...
{
	return [[self alloc] initWithTitle:title cancelButtonTitle:cancelBtnTitle
                      numberOfSections:sectionsBlock
                       titleForHeaders:titlesBlock
          ...
          andCells:(MLTableAlertTableCellsBlock)cellsBlock
{
	...
	if (self)
	{
        _numberOfSections = sectionsBlock;
        _titleForHeaders = titlesBlock;
